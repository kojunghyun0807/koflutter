...
void main(){
  ...
  // 고차 함수(함수를 매개변수로'전달 받거나 봔한하는 함수)
  int result = calc(10, 5, minus);
  print('result : ${result}');

  var helloFunc = createHello("홍길동");
  print(helloFunc());
  ...
  // 선택적 위치 매개변수(Optional Positional Parameter, [대관호] 매개변수)
  user1('김유신');
  user1('김춘추', 21);
  user2('장보고');
  user2('강감찬', 21);
